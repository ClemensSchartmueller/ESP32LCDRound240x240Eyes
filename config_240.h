...
#define EYE_1_YPOSITION  60  // y shift for eye 1 image on display
...
// rotation value (0-3) and x position offset for that eye.
  ...
  eyeInfo_t eyeInfo[] = {
    ...
    { TFT2_CS, RH_WINK_PIN, TFT_2_ROT, EYE_2_XPOSITION, EYE_1_YPOSITION }, // RIGHT EYE chip select and wink pins, rotation and offset
  };
#else
  eyeInfo_t eyeInfo[] = {
    { TFT1_CS, LH_WINK_PIN, TFT_1_ROT, EYE_1_XPOSITION, EYE_1_YPOSITION }, // EYE chip select and wink pins, rotation and offset
  };
#endif
